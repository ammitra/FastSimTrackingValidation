...
def BtagValPlotting(valdirs,names):
    ...
    with helper.cd('btag_plots/'):
        plotFactory_cmd = 'python %s/Validation-Tools/plotProducer/scripts/plotFactory.py -f ../../%s -F ../../%s -r %s -R %s -s TTbar_13TeV_TuneCUETP8M1 -S TTbar_13TeV_TuneCUETP8M1_cfi'%(cwd,first,second,names[0],names[1])
